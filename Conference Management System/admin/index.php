...
<body>
  ...
  <section class="top-bar-section">
    ...
    <?php endif ?></li>
      <li class="divider"></li>
      <li style="padding-left: 15px; padding-right: 15px;"><a  href="conference/index.php">Conferences</a></li>
      <li class="divider"></li>
      <li class="divider"></li>
      <li style="padding-left: 15px; padding-right: 15px;"><a  href="reviewer/index.php">Reviewer</a></li>
      <li class="divider"></li>
      <li class="divider"></li>
